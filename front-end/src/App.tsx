      ...
      <div
          ...
          >
              ...
              <div className="menu flex flex-col justify-center gap-1">
                {RouteData.map((item, index) => (
                  ...
                  >
                    <Link
                      to={item.path}
                      className="flex flex-col items-center justify-center w-full h-full no-underline debug"
                    >
                      {/* {item.logo} */}
            ...
            <div className="flex-1 flex flex-col bg-[#F4F5F7] w-screen ">
              ...
              >
                <div className="ml-auto flex gap-4 justify-center items-center w-full debug">
                  <div className="flex justify-between w-full gap-2" ref={inputRef}>
                    <div>
                    <h1 className=' text-red-500 '>ساعة مع الحمرا</h1>
                    </div>
                    <div>
                    <IconButton
          ...
          <div className="bottom-0 z-50 w-screen fixed h-[10rem] bg-white  md:hidden overflow-auto flex px-1  ">
            ...
            <div className="flex   mx-2 justify-between w-full">
              {RouteData.map((item, index) => (
                <motion.div
                  key={index}
                  className={`relative menu-item flex flex-col gap-1 items-center w-[4rem] justify-center h-full cursor-pointer hover:bg-[#F4F6FF]  ${
                    item.path === location.pathname && ""
                  }`}
                  initial={{ scale: 1 }}
                  whileTap={{ scale: 1.2 }}
